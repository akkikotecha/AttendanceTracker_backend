...
function getData()
{
              ...
              $.ajax({
                ...
                method:"POST",
                data:{date:$('#startShiftDate').val(),selectJobSiteid:window.localStorage.getItem("selectJobSiteid"),prj_id:window.localStorage.getItem('id'),parent_id:window.localStorage.getItem("parent_attedanceID")},
                headers: {
