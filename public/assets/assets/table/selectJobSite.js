                ...
                $.each(result, (i, val) => {
                   ...
                   // var FormatestartedDate = [startDate.getFullYear(), startDate.getMonth() + 1, startDate.getDate()].join('-');
                    ...
                    }else
                    {
                      ...
                      items.push({ "ID": val._id,"site_name": val.site_name, "address": val.address, "start_date": startedDate, "end_date": endedDate, "status": val.status,'StartDate':FormatestartedDate,'EndDate':FormateendedDate });
                  })
...
//                    editable: "incell",
                            ...
                            
                    {
                        ...
                        template: "<button class='btn btn-primary AttedanceRedirect' data-val=#: ID # title='' >Mark Attendance</button>",
                        width: 220
